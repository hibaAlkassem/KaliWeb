...
(function ($, window, document, undefined) {
    ...
    Timepicker.prototype = {
        ...
        _init: function () {
            ...
            if (this.showWidgetOnAddonClick && (this.$element.parent().parent().hasClass('input-append') || this.$element.parent().hasClass('input-prepend'))) {
        ...
        getTemplate: function () {
            ...
            templateContent = '<table>' +
                ...
                '<td> <i class="fa fa-trash-o remove-time"></i> </td>' +
                '</tr>' +
                '<tr>' +
        ...
        place: function () {
            ...
            var ctr = 0;
            var elementInput = this.$element[0];
            var elemnetIndex = 0;

            $('input.dosage-time').each(function () {

                if ($('input.dosage-time')[ctr] == elementInput) {
                    elemnetIndex = ctr;
                    return;
                }
                ctr++;
            ...
            console.log(elemnetIndex);
            console.log((elemnetIndex) % 6);

            this.$widget.css({
                top: 530 + 52.5 * (Math.floor(elemnetIndex/6) ),
                left: left + 1,
                zIndex: zIndex
            });
        },
        ...
        showWidget: function () {
            if ($('.bootstrap-timepicker-widget').length == 1) $('.bootstrap-timepicker-widget').show();
            if (this.isOpen) {
                return;
            }
            ...
            getTimepickerCurrentValue(this.$element, this.$element.val());
            if (this.$element.val() == '')
                $('i.remove-time').hide();
            else $('i.remove-time').show();
